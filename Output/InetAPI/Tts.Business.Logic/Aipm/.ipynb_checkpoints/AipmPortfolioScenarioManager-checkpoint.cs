...
//===============================================================
        public static async Task<IEnumerable<PortfolioAnnualBudgetDataAltSummaryResult>> PortfolioAnnualBudgetDataAltSummary(int scenarioId, AipmPortfolioResultFilter filter)
        {
            ...
            var innerSql = $"SELECT \"YearIndex\" + \"StartYear\" AS \"Year\" , null as \"FILLER\", SUM(\"BUDY\")/1000000 AS \"BUDY\" FROM ( SELECT proj.\"YearIndex\" , proj.\"Plan_ID\" , proj.\"Project_ID\" , proj.\"BUDY\" , proj.\"resType\" , mp.\"Id\" , mp.\"UDCFG_GeoStateCode\" , mp.\"UDCFG_BusinessAreaCode\", mp.\"UDProjectType\" , mp.\"UDVoltagekV\" , mp.\"UDStrategicObjective\" , config.\"StartYear\" , config.\"EndYear\" FROM ( SELECT \'Prioritised\' AS \"resType\" , 0 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY1\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 1 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY2\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 2 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY3\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 3 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY4\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 4 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY5\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 5 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY6\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 6 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY7\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Prioritised\' AS \"resType\" , 7 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY8\" AS \"BUDY\" , \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 0 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY1\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 1 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY2\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 2 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY3\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 3 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY4\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 4 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY5\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 5 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY6\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 6 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY7\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\" , 7 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY8\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 0 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY1\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 1 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY2\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 2 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY3\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 3 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY4\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 4 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY5\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 5 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY6\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 6 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY7\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" UNION SELECT \'Defer\' AS \"resType\" , 7 AS \"YearIndex\", \"Plan_ID\" , \"Project_ID\" , \"BUDY8\" AS \"BUDY\" , NULL AS \"Defer\" FROM public.\"PortfolioOpt_Deferred_Proj\" ) AS proj INNER JOIN public.\"MP_Project\" AS mp ON proj.\"Project_ID\" = mp.\"Id\" INNER JOIN public.\"AIPM_PortfolioScenario\" as config on proj.\"Plan_ID\" = config.\"Id\" WHERE \"Plan_ID\" = (@id) AND ( ( \"resType\" = \'Prioritised\' AND ( \"Defer\" IS NULL OR \"Defer\" IS FALSE ) ) OR ( \"resType\" = \'Alternate\' ) OR ( \"resType\" = \'Defer\' ) ) " + where + " ) AS resultset Where \"YearIndex\" + \"StartYear\" <= \"EndYear\" GROUP BY \"YearIndex\", \"Plan_ID\" , \"StartYear\", \"EndYear\" order by \"YearIndex\";";
