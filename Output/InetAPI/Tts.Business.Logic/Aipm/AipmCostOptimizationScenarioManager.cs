...
//===============================================================
// TEMPLATE START: AipmCostManager.cs.1.2.tpl
//===============================================================
        public static async Task<List<Dictionary<string, object>>> getSceEvalRiskAssesFinalResultSimulGrid(int scenarioId, AipmCostFilters model)
        {
            var commandText = "";
            ...
            var sql = $"select aa.\"UDProjectType\" , aa.\"UDVoltagekV\" , aa.\"UDCFG_GeoStateCode\" , aa.\"UDCFG_BusinessAreaCode\" , aa.\"UDCFG_BusinessAreaName\" , aa.\"UDCFG_GeoStateName\" , sum(aa.\"Scope1Budget\") as \"Total_Scope1Budget\" , sum(\"Scope1Budget\" + \"Scope1Budget\" * coalesce(\"OverBudget_Value1\", 0) / 100) AS \"Total_ADJ_Scope1Budget\", sum(aa.\"Scope2Budget\") as \"Total_Scope2Budget\" , sum(\"Scope2Budget\" + \"Scope2Budget\" * coalesce(\"OverBudget_Value2\", 0) / 100) AS \"Total_ADJ_Scope2Budget\", sum(aa.\"Scope3Budget\") as \"Total_Scope3Budget\" , sum(\"Scope3Budget\" + \"Scope3Budget\" * coalesce(\"OverBudget_Value3\", 0) / 100) AS \"Total_ADJ_Scope3Budget\", sum(aa.\"Scope4Budget\") as \"Total_Scope4Budget\" , sum(\"Scope4Budget\" + \"Scope4Budget\" * coalesce(\"OverBudget_Value4\", 0) / 100) AS \"Total_ADJ_Scope4Budget\", sum(aa.\"Scope1Budget\" + aa.\"Scope2Budget\" + aa.\"Scope3Budget\" + aa.\"Scope4Budget\") as \"Total_ScopeBudget\", sum(   (\"Scope1Budget\" + \"Scope1Budget\" * coalesce(\"OverBudget_Value1\", 0) / 100) +    (\"Scope2Budget\" + \"Scope2Budget\" * coalesce(\"OverBudget_Value2\", 0) / 100) +    (\"Scope3Budget\" + \"Scope3Budget\" * coalesce(\"OverBudget_Value3\", 0) / 100) +    (\"Scope4Budget\" + \"Scope4Budget\" * coalesce(\"OverBudget_Value4\", 0) / 100) ) as \"Total_ADJ_ScopeBudget\" from ( SELECT a.\"UDProjectType\" , a.\"UDVoltagekV\" , a.\"UDCFG_GeoStateCode\" , a.\"UDCFG_BusinessAreaCode\" , f.\"scenarioid\" , b.\"AreaName\" AS \"UDCFG_BusinessAreaName\", c.\"Name\" AS \"UDCFG_GeoStateName\" , COALESCE(d.\"UDScope1Budget\", d.\"Scope1Budget\", 0.00) AS \"Scope1Budget\" , COALESCE(d.\"UDScope2Budget\", d.\"Scope2Budget\", 0.00) AS \"Scope2Budget\" , COALESCE(d.\"UDScope3Budget\", d.\"Scope3Budget\", 0.00) AS \"Scope3Budget\" , COALESCE(d.\"UDScope4Budget\", d.\"Scope4Budget\", 0.00) AS \"Scope4Budget\" FROM \"MP_Project\" AS a LEFT JOIN public.\"CFG_BusinessArea\" AS b ON a.\"UDCFG_BusinessAreaCode\" = b.\"AreaCode\" LEFT JOIN public.\"CFG_GeoState\" AS c ON a.\"UDCFG_GeoStateCode\" = c.\"Code\" LEFT JOIN public.\"MP_BudgetSchedule\" AS d ON a.\"Id\" = d.\"MP_ProjectId\" LEFT JOIN public.aipmcostoptimizationscenario AS e ON CASE WHEN e.\"isNational\" = false THEN a.\"UDCFG_GeoStateCode\" = e.\"stateCode\" ELSE e.\"isNational\" = true END LEFT JOIN ( select distinct \"projectid\", \"scenarioid\" from public.aipmcostoptimizationprojects) as f on a.\"Id\" = f.\"projectid\" and e.id = f.\"scenarioid\" WHERE ( a.\"ProjectStatus\" LIKE \'CRTD%\' OR a.\"ProjectStatus\" LIKE \'REL%\' OR a.\"ProjectStatus\" LIKE \'PREL%\') AND a.\"UDCategory\" = \'System Project\' AND e.id = (@id) and f.\"scenarioid\" is not null"+ commandText + ") as aa Left JOIN ( select \"Project_Type\" , \"Voltage_Type\" , \"state\" , \"business_area\" , \"Plan_ID\" , max(\"OverBudget_Value1\") as \"OverBudget_Value1\", max(\"OverBudget_Value2\") as \"OverBudget_Value2\", max(\"OverBudget_Value3\") as \"OverBudget_Value3\", max(\"OverBudget_Value4\") as \"OverBudget_Value4\" from ( SELECT a.\"Project_Type\" , a.\"Voltage_Type\" , a.\"state\" , a.\"business_area\", a.\"Plan_ID\" , case when cast(a.\"Scope\" as text) = \'1\' and a.\"VarName\" = \'Estimate_OverBudget_Percent\' then a.\"User_Input\" end as \"OverBudget_Value1\", case when cast(a.\"Scope\" as text) = \'2\' and a.\"VarName\" = \'Estimate_OverBudget_Percent\' then a.\"User_Input\" end as \"OverBudget_Value2\", case when cast(a.\"Scope\" as text) = \'3\' and a.\"VarName\" = \'Estimate_OverBudget_Percent\' then a.\"User_Input\" end as \"OverBudget_Value3\", case when cast(a.\"Scope\" as text) = \'4\' and a.\"VarName\" = \'Estimate_OverBudget_Percent\' then a.\"User_Input\" end as \"OverBudget_Value4\" FROM public.\"Profiling_Final_Result_Trans\" AS a WHERE a.\"Plan_ID\" = (@id2) AND a.\"VarName\" = \'Estimate_OverBudget_Percent\') as pfrt group by \"Project_Type\" , \"Voltage_Type\" , \"state\" , \"business_area\", \"Plan_ID\") as bb on aa.\"UDProjectType\" = bb.\"Project_Type\" or ( aa.\"UDProjectType\" is null and bb.\"Project_Type\" is null) and aa.\"UDVoltagekV\" = cast(bb.\"Voltage_Type\" as text) and aa.\"UDCFG_GeoStateCode\" = bb.\"state\" and aa.\"UDCFG_BusinessAreaCode\" = bb.\"business_area\" group by aa.\"UDCFG_GeoStateCode\" , aa.\"UDCFG_GeoStateName\" , aa.\"UDCFG_BusinessAreaCode\", aa.\"UDCFG_BusinessAreaName\", aa.\"UDProjectType\" , aa.\"UDVoltagekV\" order by aa.\"UDCFG_GeoStateCode\" , aa.\"UDCFG_GeoStateName\" , aa.\"UDCFG_BusinessAreaCode\", aa.\"UDCFG_BusinessAreaName\", aa.\"UDProjectType\" , aa.\"UDVoltagekV\"";
...
//===============================================================
// TEMPLATE END: AipmCostManager.cs.1.2.tpl
//===============================================================
