...
//===============================================================
// TEMPLATE START: AipmCostController.cs.1.1.tpl
//===============================================================
        [HttpPost("SceEvalRiskAssesFinalResultSimulGrid/{scenarioId}")]
        public async Task<IActionResult> SceEvalRiskAssesFinalResultSimulGrid(int scenarioId, AipmCostFilters filter)
        {
            if (_workContext.Username == null)
                return Unauthorized();
        
            var result = await AipmCostOptimizationScenarioManager.getSceEvalRiskAssesFinalResultSimulGrid(scenarioId, filter);
            return Ok(result);
        }
//===============================================================
// TEMPLATE END: AipmCostController.cs.1.1.tpl
//===============================================================
