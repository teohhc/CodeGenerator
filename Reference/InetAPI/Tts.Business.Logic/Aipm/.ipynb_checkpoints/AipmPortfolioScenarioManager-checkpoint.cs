...
//===============================================================
        public static async Task<IEnumerable<PortfolioAnnualBudgetDataSummaryResult>> PortfolioAnnualBudgetDataSummary(int scenarioId, AipmPortfolioResultFilter filter)
        {
            ...
            var innerSql = $"SELECT \"YearIndex\" + \"StartYear\" AS \"Year\", null as \"FILLER\", SUM(\"BUDY\")/1000000 AS \"BUDY\" FROM ( SELECT proj.\"YearIndex\", proj.\"Plan_ID\", proj.\"Project_ID\", proj.\"BUDY\", proj.\"resType\", mp.\"Id\", mp.\"UDCFG_GeoStateCode\", mp.\"UDCFG_BusinessAreaCode\", mp.\"UDProjectType\", mp.\"UDVoltagekV\", mp.\"UDStrategicObjective\", config.\"StartYear\", config.\"EndYear\" FROM ( SELECT \'Approved\' AS \"resType\", 0 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY1\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 1 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY2\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 2 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY3\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 3 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY4\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 4 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY5\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 5 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY6\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 6 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY7\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Approved\' AS \"resType\", 7 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY8\" AS \"BUDY\", \"Defer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 0 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY1\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 1 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY2\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 2 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY3\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 3 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY4\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 4 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY5\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 5 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY6\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 6 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY7\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" UNION SELECT \'Alternate\' AS \"resType\", 7 AS \"YearIndex\", \"Plan_ID\", \"Project_ID\", \"BUDY8\" AS \"BUDY\", NULL AS \"Defer\" FROM public.\"PortfolioOpt_Alternate_Proj\" ) AS proj INNER JOIN public.\"MP_Project\" AS mp ON proj.\"Project_ID\" = mp.\"Id\" INNER JOIN public.\"AIPM_PortfolioScenario\" as config on proj.\"Plan_ID\" = config.\"Id\" WHERE \"Plan_ID\" = (@id) AND ( ( \"resType\" = \'Approved\' AND ( \"Defer\" IS NULL OR \"Defer\" IS FALSE ) ) OR (\"resType\" = \'Alternate\') ) " + where + " ) AS resultset Where \"YearIndex\" + \"StartYear\" <= \"EndYear\" GROUP BY \"YearIndex\", \"Plan_ID\", \"StartYear\", \"EndYear\" order by \"YearIndex\";";
...
//===============================================================
        public static async Task<IEnumerable<PortfolioOSRiskDataSummaryResult>> PortfolioOSRiskDataSummary(int scenarioId, AipmPortfolioResultFilter filter)
        {
            ...
            var innerSql = $"WITH PlanData AS (SELECT DISTINCT ON (\"Plan_ID\") \"Plan_ID\" FROM public.\"PortfolioOpt_Approved_Proj\" WHERE \"Plan_ID\" = (@id)), ScenarioData AS ( Select \"Year\", \"Description\", \"Value\"/1000000 as \"Value\" from ( Select *, case when \"DescripOrder\" = 0 and \"resType\" = \'Rejected\' then 1 when \"DescripOrder\" = 1 and \"resType\" = \'Rejected\' then 2 when \"DescripOrder\" = 2 and \"resType\" = \'Rejected\' then 3 when \"DescripOrder\" = 0 and \"resType\" = \'Delay\' then 4 when \"DescripOrder\" = 1 and \"resType\" = \'Delay\' then 5 when \"DescripOrder\" = 2 and \"resType\" = \'Delay\' then 6 end as \"porder\", case when \"DescripOrder\" = 0 and \"resType\" = \'Rejected\' then \'NPV_RiskReduced - Rejected\' when \"DescripOrder\" = 1 and \"resType\" = \'Rejected\' then \'Inflation - Rejected\' when \"DescripOrder\" = 2 and \"resType\" = \'Rejected\' then \'NPV_RiskReducedGrowth - Rejected\' when \"DescripOrder\" = 0 and \"resType\" = \'Delay\' then \'NPV_RiskReduced - Delay\' when \"DescripOrder\" = 1 and \"resType\" = \'Delay\' then \'Inflation - Delay\' when \"DescripOrder\" = 2 and \"resType\" = \'Delay\' then \'NPV_RiskReducedGrowth - Delay\' end as \"Description\", case when \"DescripOrder\" = 0 and \"resType\" = \'Rejected\' then \"NPV_RiskReduced\" when \"DescripOrder\" = 1 and \"resType\" = \'Rejected\' then \"Inflation\" when \"DescripOrder\" = 2 and \"resType\" = \'Rejected\' then \"NPV_RiskReducedGrowth\" when \"DescripOrder\" = 0 and \"resType\" = \'Delay\' then \"NPV_RiskReduced\" when \"DescripOrder\" = 1 and \"resType\" = \'Delay\' then \"Inflation\" when \"DescripOrder\" = 2 and \"resType\" = \'Delay\' then \"NPV_RiskReducedGrowth\" end as \"Value\" from ( Select *, generate_series(0, 2) AS \"DescripOrder\" from ( SELECT \"Year\", \"NPV_RiskReduced\", \"Inflation\", SUM(\"NPV_RiskReducedGrowth\") OVER ( partition by \"resType\" ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) AS \"NPV_RiskReducedGrowth\", \"resType\" FROM ( SELECT \"Year\", sum (\"NPV_RiskReduced\") as \"NPV_RiskReduced\", SUM(\"NPV_RiskReducedGrowth\") AS \"NPV_RiskReducedGrowth\", \"Inflation\", \"resType\" FROM ( SELECT \"Year\", \"UDCFG_BusinessAreaCode\", \"NPV_RiskReduced\", ( \"NPV_RiskReduced\" * \"GrowthRate\" / 100 ) AS \"NPV_RiskReducedGrowth\", ( \"NPV_RiskReduced\" * (1 + 0.04) ^ (\"YearIndex\" + 1) - \"NPV_RiskReduced\" ) AS \"Inflation\", \"resType\" FROM ( SELECT annualnpv.\"Year\", annualnpv.\"UDCFG_BusinessAreaCode\", annualnpv.\"NPV_RiskReduced\", npvgrowth.\"GrowthRate\", annualnpv.\"resType\", annualnpv.\"YearIndex\" FROM ( SELECT COALESCE(npvsum.\"NPV_RiskReduced\", 0) as \"NPV_RiskReduced\", npvsum.\"UDCFG_BusinessAreaCode\", \"StartYear\" + \"YearIndex\" AS \"Year\", npvsum.\"resType\", \"YearIndex\" FROM ( SELECT SUM(\"NPV_RiskReduced\") AS \"NPV_RiskReduced\", npvproj.\"UDCFG_BusinessAreaCode\", npvproj.\"Plan_ID\", npvproj.\"resType\", generate_series(0, 7) AS \"YearIndex\" FROM ( SELECT proj.\"Plan_ID\", proj.\"NPV_RiskReduced\", proj.\"Project_ID\", proj.\"resType\", mp.\"Id\", mp.\"UDCFG_GeoStateCode\", mp.\"UDCFG_BusinessAreaCode\", mp.\"UDProjectType\", mp.\"UDVoltagekV\", mp.\"UDStrategicObjective\" FROM ( SELECT \'Delay\' AS \"resType\", \"Plan_ID\", \"Project_ID\", \"Project_Definition\", \"Mandatory\", \"Project_Score\", \"Risk_Reduced\", \"Total_Budget\", \"Budget_Before_Revised\", \"TCO_Opex\", \"TCO_TotalProjectCost\", \"NPV_RiskReduced\", NULL AS \"Replace\", \"Defer\", \"Option1_Safety\", \"Option1_Compliance\", \"Option1_Financial\", \"Option1_Reliability\", \"Option1_Environment\", \"Option1_Customer\" FROM public.\"PortfolioOpt_Approved_Proj\" UNION SELECT \'Rejected\' AS \"resType\", \"Plan_ID\", \"Project_ID\", \"Project_Definition\", \"Mandatory\", \"Project_Score\", \"Risk_Reduced\", \"Total_Budget\", \"Budget_Before_Revised\", \"TCO_Opex\", \"TCO_TotalProjectCost\", \"NPV_RiskReduced\", \"Replace\", NULL AS \"Defer\", \"Option1_Safety\", \"Option1_Compliance\", \"Option1_Financial\", \"Option1_Reliability\", \"Option1_Environment\", \"Option1_Customer\" FROM public.\"PortfolioOpt_Rejected_Proj\" ) AS proj INNER JOIN public.\"MP_Project\" AS mp ON proj.\"Project_ID\" = mp.\"Id\" WHERE \"Plan_ID\" IN ( SELECT \"Plan_ID\" FROM PlanData ) AND ( ( \"resType\" = \'Delay\' AND (\"Defer\" IS TRUE) ) OR ( \"resType\" = \'Rejected\' AND ( \"Replace\" IS NULL OR \"Replace\" IS FALSE ) ) ) " + where + " ) AS npvproj GROUP BY npvproj.\"UDCFG_BusinessAreaCode\", npvproj.\"Plan_ID\", npvproj.\"resType\" ) AS npvsum INNER JOIN public.\"AIPM_PortfolioScenario\" AS ps ON npvsum.\"Plan_ID\" = ps.\"Id\" WHERE \"EndYear\" - \"StartYear\" >= \"YearIndex\" ) AS annualnpv LEFT JOIN ( SELECT b.\"CFG_BusinessAreaCode\", b.\"Year\", CASE WHEN b.\"GrowthRate\" <= 0 THEN 0 ELSE b.\"GrowthRate\" END AS \"GrowthRate\" FROM ( SELECT \"Id\" FROM ( SELECT \"cycleId\" FROM public.\"AIPM_PortfolioScenario\" WHERE \"Id\" IN ( SELECT \"Plan_ID\" FROM PlanData ) ) AS cycleid INNER JOIN public.\"LF_Project\" AS LF ON cycleid.\"cycleId\" = LF.\"CFG_CycleId\" WHERE \"WorkflowStatus\" != \'PendingSubmission\' AND \"ForecastType\" = \'Demand\' AND \"Deleted\" = \'false\' ) AS LFID INNER JOIN public.\"LF_GrowthResult\" AS b ON LFID.\"Id\" = b.\"LF_ProjectId\" ) AS npvgrowth ON annualnpv.\"Year\" = npvgrowth.\"Year\" AND annualnpv.\"UDCFG_BusinessAreaCode\" = npvgrowth.\"CFG_BusinessAreaCode\" GROUP BY annualnpv.\"Year\", annualnpv.\"UDCFG_BusinessAreaCode\", annualnpv.\"NPV_RiskReduced\", npvgrowth.\"GrowthRate\", annualnpv.\"resType\", annualnpv.\"YearIndex\" ORDER BY \"Year\" ) AS compiledtable ) AS inflationcalculation GROUP BY \"Year\", \"Inflation\", \"resType\" ORDER BY \"Year\" ) AS removeBA ORDER BY \"resType\", \"Year\" ) as crossjoin ) as transposestep1 order by \"Year\", \"porder\" ) as finaltable order by \"Year\", \"porder\" ) select * from ScenarioData";
...
//===============================================================
        ...
        public static async Task<IEnumerable<PortfolioOptSummaryResult>> PortfolioAlternateResultsSummary(int scenarioId, AipmPortfolioResultFilter filter)
        {
            ...
            var approvedSql = $"SELECT COALESCE(SUM(a.\"Budget_Before_Revised\"), 0.00) AS \"BudgetBeforeRevised\", COALESCE(SUM(a.\"Total_Budget\"), 0.00) AS \"TotalBudget\", COALESCE(SUM(a.\"Project_Score\"), 0.00) AS \"ProjectScore\", COALESCE(SUM(a.\"TCO_Opex\"), 0.00)*1000000 AS \"TCOOpex\", COALESCE(SUM(a.\"TCO_TotalProjectCost\"), 0.00)*1000000 AS \"TCOTotalProjectCost\", COALESCE(SUM(a.\"NPV_RiskReduced\"), 0.00) AS \"NPVRiskReduced\", COALESCE(SUM(a.\"Risk_Reduced\"), 0.00)*1000000 AS \"RiskReduced\", COALESCE(SUM(a.\"BUDY1\"), 0.00) AS \"BUDY1\", COALESCE(SUM(a.\"BUDY2\"), 0.00) AS \"BUDY2\", COALESCE(SUM(a.\"BUDY3\"), 0.00) AS \"BUDY3\", COALESCE(SUM(a.\"BUDY4\"), 0.00) AS \"BUDY4\", COALESCE(SUM(a.\"BUDY5\"), 0.00) AS \"BUDY5\", COALESCE(SUM(a.\"BUDY6\"), 0.00) AS \"BUDY6\", COALESCE(SUM(a.\"BUDY7\"), 0.00) AS \"BUDY7\", COALESCE(SUM(a.\"BUDY8\"), 0.00) AS \"BUDY8\", COUNT(*) AS \"TotalProject\" FROM public.\"PortfolioOpt_Approved_Proj\" AS a INNER JOIN public.\"MP_Project\" AS b ON a.\"Project_ID\" = b.\"Id\" WHERE a.\"Plan_ID\"=(@id) AND (a.\"Defer\" IS NULL OR a.\"Defer\" = false)" + where;

            var approvedParams = new { id = scenarioId };
            var approvedSummary = (await DbHelper.ExecuteDql<PortfolioOptSummaryResult>(approvedSql, approvedParams)).FirstOrDefault();
            approvedSummary.Summary = "Prioritised";

            var alternateSql = $"SELECT COALESCE(SUM(a.\"Budget_Before_Revised\"), 0.00) AS \"BudgetBeforeRevised\", COALESCE(SUM(a.\"Total_Budget\"), 0.00) AS \"TotalBudget\", COALESCE(SUM(a.\"Project_Score\"), 0.00) AS \"ProjectScore\", COALESCE(SUM(a.\"TCO_Opex\"), 0.00)*1000000 AS \"TCOOpex\", COALESCE(SUM(a.\"TCO_TotalProjectCost\"), 0.00)*1000000 AS \"TCOTotalProjectCost\", COALESCE(SUM(a.\"NPV_RiskReduced\"), 0.00) AS \"NPVRiskReduced\", COALESCE(SUM(a.\"Risk_Reduced\"), 0.00)*1000000 AS \"RiskReduced\", COALESCE(SUM(a.\"BUDY1\"), 0.00) AS \"BUDY1\", COALESCE(SUM(a.\"BUDY2\"), 0.00) AS \"BUDY2\", COALESCE(SUM(a.\"BUDY3\"), 0.00) AS \"BUDY3\", COALESCE(SUM(a.\"BUDY4\"), 0.00) AS \"BUDY4\", COALESCE(SUM(a.\"BUDY5\"), 0.00) AS \"BUDY5\", COALESCE(SUM(a.\"BUDY6\"), 0.00) AS \"BUDY6\", COALESCE(SUM(a.\"BUDY7\"), 0.00) AS \"BUDY7\", COALESCE(SUM(a.\"BUDY8\"), 0.00) AS \"BUDY8\", COUNT(*) AS \"TotalProject\" FROM public.\"PortfolioOpt_Alternate_Proj\" AS a INNER JOIN public.\"MP_Project\" AS b ON a.\"Project_ID\" = b.\"Id\" WHERE a.\"Plan_ID\"=(@id)" + where;
            ...
            */
            ...
            var deferredSql = $"SELECT COALESCE(SUM(a.\"Budget_Before_Revised\"), 0.00) AS \"BudgetBeforeRevised\", COALESCE(SUM(a.\"Total_Budget\"), 0.00) AS \"TotalBudget\", COALESCE(SUM(a.\"Project_Score\"), 0.00) AS \"ProjectScore\", COALESCE(SUM(a.\"TCO_Opex\"), 0.00)*1000000 AS \"TCOOpex\", COALESCE(SUM(a.\"TCO_TotalProjectCost\"), 0.00)*1000000 AS \"TCOTotalProjectCost\", COALESCE(SUM(a.\"NPV_RiskReduced\"), 0.00) AS \"NPVRiskReduced\", COALESCE(SUM(a.\"Risk_Reduced\"), 0.00)*1000000 AS \"RiskReduced\", COALESCE(SUM(a.\"BUDY1\"), 0.00) AS \"BUDY1\", COALESCE(SUM(a.\"BUDY2\"), 0.00) AS \"BUDY2\", COALESCE(SUM(a.\"BUDY3\"), 0.00) AS \"BUDY3\", COALESCE(SUM(a.\"BUDY4\"), 0.00) AS \"BUDY4\", COALESCE(SUM(a.\"BUDY5\"), 0.00) AS \"BUDY5\", COALESCE(SUM(a.\"BUDY6\"), 0.00) AS \"BUDY6\", COALESCE(SUM(a.\"BUDY7\"), 0.00) AS \"BUDY7\", COALESCE(SUM(a.\"BUDY8\"), 0.00) AS \"BUDY8\", COUNT(*) AS \"TotalProject\" FROM public.\"PortfolioOpt_Approved_Proj\" AS a INNER JOIN public.\"MP_Project\" AS b ON a.\"Project_ID\" = b.\"Id\" WHERE a.\"Plan_ID\"=(@id) AND a.\"Defer\" = true and a.\"Defer_ID\" is not null" + where;
            ...
            var cancelledSql = $"SELECT COALESCE(SUM(a.\"Budget_Before_Revised\"), 0.00) AS \"BudgetBeforeRevised\", COALESCE(SUM(a.\"Total_Budget\"), 0.00) AS \"TotalBudget\", COALESCE(SUM(a.\"Project_Score\"), 0.00) AS \"ProjectScore\", COALESCE(SUM(a.\"TCO_Opex\"), 0.00)*1000000 AS \"TCOOpex\", COALESCE(SUM(a.\"TCO_TotalProjectCost\"), 0.00)*1000000 AS \"TCOTotalProjectCost\", COALESCE(SUM(a.\"NPV_RiskReduced\"), 0.00) AS \"NPVRiskReduced\", COALESCE(SUM(a.\"Risk_Reduced\"), 0.00)*1000000 AS \"RiskReduced\", COALESCE(SUM(a.\"BUDY1\"), 0.00) AS \"BUDY1\", COALESCE(SUM(a.\"BUDY2\"), 0.00) AS \"BUDY2\", COALESCE(SUM(a.\"BUDY3\"), 0.00) AS \"BUDY3\", COALESCE(SUM(a.\"BUDY4\"), 0.00) AS \"BUDY4\", COALESCE(SUM(a.\"BUDY5\"), 0.00) AS \"BUDY5\", COALESCE(SUM(a.\"BUDY6\"), 0.00) AS \"BUDY6\", COALESCE(SUM(a.\"BUDY7\"), 0.00) AS \"BUDY7\", COALESCE(SUM(a.\"BUDY8\"), 0.00) AS \"BUDY8\", COUNT(*) AS \"TotalProject\" FROM public.\"PortfolioOpt_Approved_Proj\" AS a INNER JOIN public.\"MP_Project\" AS b ON a.\"Project_ID\" = b.\"Id\" WHERE a.\"Plan_ID\"=(@id) AND a.\"Defer\" = true and a.\"Defer_ID\" is null" + where;
            ...
            var rejectSql = $"SELECT COALESCE(SUM(a.\"Budget_Before_Revised\"), 0.00) AS \"BudgetBeforeRevised\", COALESCE(SUM(a.\"Total_Budget\"), 0.00) AS \"TotalBudget\", COALESCE(SUM(a.\"Project_Score\"), 0.000) AS \"ProjectScore\", COALESCE(SUM(a.\"TCO_Opex\"), 0.00)*1000000 AS \"TCOOpex\", COALESCE(SUM(a.\"TCO_TotalProjectCost\"), 0.00)*1000000 AS \"TCOTotalProjectCost\", COALESCE(SUM(a.\"NPV_RiskReduced\"), 0.00) AS \"NPVRiskReduced\", COALESCE(SUM(a.\"Risk_Reduced\"), 0.000)*1000000 AS \"RiskReduced\", COUNT(*) AS \"TotalProject\" FROM public.\"PortfolioOpt_Rejected_Proj\" AS a INNER JOIN public.\"MP_Project\" AS b ON a.\"Project_ID\" = b.\"Id\" WHERE a.\"Plan_ID\"=(@id) AND (a.\"Replace\" IS NULL OR a.\"Replace\" = false) " + where;
            var rejectParams = new { id = scenarioId };
            var rejectSummary = (await DbHelper.ExecuteDql<PortfolioOptSummaryResult>(rejectSql, rejectParams)).FirstOrDefault();
        ...
        public static async Task<bool> PortfolioResultsAlternateProjectInsert(int scenarioId, int projectId)
        {
            ...
            var sbQuery = new StringBuilder("INSERT INTO  public.\"PortfolioOpt_Alternate_Proj\" (\"Plan_ID\",\"Project_ID\",\"Project_Definition\", \"Project_Score\", \"Risk_Reduced\", \"Total_Budget\", \"TCO_Opex\", \"TCO_TotalProjectCost\", \"NPV_RiskReduced\", \"Target_Comm_Month\") ");
            sbQuery.Append("SELECT " + scenarioId + "," + projectId + ", a.\"ProjectDefinition\", COALESCE(a.\"ProjectScore\", 0.000), COALESCE(a.\"TotalRiskAnnual_RiskReduced\", 0.000), (" +
                ...
                ") AS \"TotalBudget\", a.\"CapexInvest_Opex\", a.\"CapexInvest_TotalProjectCost\", a.\"NPVTotalRiskReducedInThousand_EI\"::double precision, CAST(a.\"UDTargetCommissionDate\" AS DATE)");
            ...
            if (response)
            {
                ...
                try
                {
                    var json = JsonConvert.SerializeObject("");
                    var data = new StringContent(json, Encoding.UTF8, "application/json");
                    var endPoint = "https://ncpsas-stg.hq.tnb.com.my:8343/SASStoredProcess/do?_program=%2FINET+Data+Management%2F07+STP%2FAIPM%2FPortfolio_AlternateProj&_username=sas.admin&_password=S@Ssystem18&plan_id=" + scenarioId + "&project_id=" + projectId;
                    clientHandler.ServerCertificateCustomValidationCallback = (sender, cert, chain, sslPolicyErrors) => true;
                    var client = new HttpClient(clientHandler);
                    client.PostAsync(endPoint, data);
                }
...
//===============================================================
// TEMPLATE START: AipmPortfolioScenarioManager.cs.3.1.tpl
//===============================================================
...
//===============================================================
// TEMPLATE END: AipmPortfolioScenarioManager.cs.3.1.tpl
//===============================================================
...
//===============================================================
        public static async Task<PortfolioAnnualBudgetDataSummaryChartModel> GetLeftBarLineBudgetChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.6.tpl
//===============================================================
        public static async Task<PortfolioAnnualBudgetDataSummaryChartModel> GetRightBarLineBudgetChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioAnnualBudgetDataSummary(scenarioId, filter);
            var barChartModel = new PortfolioAnnualBudgetDataSummaryInternalChartModel();
            // Get uniq labels
...
//===============================================================
        public static async Task<PortfolioBudgetvsStratDataSummaryChartModel> GetLeftStackedBarBudgetChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.3.tpl
//===============================================================
        public static async Task<PortfolioBudgetvsStratDataSummaryChartModel> GetRightStackedBarBudgetChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioBudgetvsStratDataSummary(scenarioId, filter);
            var barChartModel = new PortfolioBudgetvsStratDataSummaryChartModel();
            // Get uniq labels
...
//===============================================================
        public static async Task<PortfolioNPVvsCommMthDataSummaryChartModel> GetLeftBarLineNPVChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.7.tpl
//===============================================================
        public static async Task<PortfolioNPVvsCommMthDataSummaryChartModel> GetRightBarLineNPVChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioNPVvsCommMthDataSummary(scenarioId, filter);
            var barChartModel = new PortfolioNPVvsCommMthDataSummaryInternalChartModel();
            // Get uniq labels
...
// TEMPLATE START: ScenarioManager.cs.1.3.tpl
//===============================================================
        public static async Task<PortfolioNPVvsStratDataSummaryChartModel> GetLeftStackedBarNPVChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.3.tpl
//===============================================================
        public static async Task<PortfolioNPVvsStratDataSummaryChartModel> GetRightStackedBarNPVChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioNPVvsStratDataSummary(scenarioId, filter);
            var barChartModel = new PortfolioNPVvsStratDataSummaryChartModel();
            // Get uniq labels
...
//===============================================================
        public static async Task<PortfolioCumalRiskvsEleDataSummaryChartModel> GetLeftRadarElementChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.2.tpl
//===============================================================
        public static async Task<PortfolioCumalRiskvsEleDataSummaryChartModel> GetRightRadarElementChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioCumalRiskvsEleDataSummary(scenarioId, filter);
...
// TEMPLATE START: ScenarioManager.cs.1.3.tpl
//===============================================================
        public static async Task<PortfolioOSRiskDataSummaryChartModel> GetLeftStackedBarOSRiskChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
...
// TEMPLATE START: ScenarioManager.cs.1.3.tpl
//===============================================================
        public static async Task<PortfolioOSRiskDataSummaryChartModel> GetRightStackedBarOSRiskChart(int scenarioId, AipmPortfolioResultFilter filter)
        {
            var summaryData = await PortfolioOSRiskDataSummary(scenarioId, filter);
            var barChartModel = new PortfolioOSRiskDataSummaryChartModel();
            // Get uniq labels
...
//===============================================================
// TEMPLATE START: AipmPortfolioScenarioManager.cs.1.2.tpl
//===============================================================
...
//===============================================================
// TEMPLATE END: AipmPortfolioScenarioManager.cs.1.2.tpl
//===============================================================
...
//===============================================================
        ...
        public static async Task<List<Dictionary<string, object>>> GetBudgetConfig(int scenarioId, int numberOfYears, string state)
        {
            ...
            {
                var commandText = "SELECT s.\"Name\" AS \"state\", b.\"AreaName\" AS \"businessArea\", b.\"AreaCode\" AS \"areaCode\", c.\"Id\" AS \"configId\"";
                ...
                if (state == "national")
                {
                    commandText += " ORDER BY \"state\", \"businessArea\"";
                }
                else
                {
                ...
                var parameters = new { scenarioId, voltage, state };
        ...
        public static async Task<bool> SaveBudgetConfig(int scenarioId, int numberOfYears, List<Dictionary<string, object>> data)
        {
            ...
            foreach (var row in data)
            {
                ...
                {
                    string colList = "\"ScenarioId\", \"Voltage\", \"AreaCode\"";
