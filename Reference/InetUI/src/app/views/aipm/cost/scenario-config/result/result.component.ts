...
//===============================================================
 ...
 'Total_ScopeBudget': { 'type': 'number', 'format': '1.2-2' },
 'Total_ADJ_ScopeBudget': { 'type': 'number', 'format': '1.2-2' },
      },
      'mergeRule': [{'type':'rowcol','instList':[{'direction':'row','areaList':{'keyCol':['UDCFG_GeoStateName'],'mergeCol':['UDCFG_GeoStateName','UDCFG_BusinessAreaName','UDProjectType','UDVoltagekV']}}]}],
      'highlightRule': {}
    };
//===============================================================
